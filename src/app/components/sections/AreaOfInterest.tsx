...
const areasOfInterest: AreaOfInterestItem[] = [
  {
    ...
    description:
      "Text analysis, language models, machine translation, sentiment analysis, and computational linguistics",
  ...
  },
  {
    ...
    description:
      "AI and computational intelligence, expert systems, knowledge representation, and reasoning",
  ...
  },
  {
    ...
    description:
      "Emotion recognition, affective computing, human-computer empathy, and social computing",
  ...
  },
  {
    ...
    description:
      "Algorithm design, complexity analysis, graph theory, optimization, and theoretical computer science",
  ...
  },
  {
    ...
    description:
      "Mathematical modeling, discrete event simulation, agent-based modeling, and computational physics",
  ...
  },
  {
    ...
    description:
      "Network protocols, distributed systems, wireless networks, and network security",
  ...
  },
  {
    ...
    description:
      "Mobile computing, context-aware systems, Internet of Things, and ambient intelligence",
  ...
  },
  {
    ...
    description:
      "Software development methodologies, requirements engineering, testing, and maintenance",
  ...
  },
  {
    ...
    description:
      "Database systems, data management, information retrieval, and knowledge bases",
  ...
  },
  {
    ...
    description:
      "Search engines, recommender systems, content-based retrieval, and multimedia information retrieval",
  ...
  },
  {
    ...
    description:
      "Quantum computing, blockchain, edge computing, bioinformatics, and interdisciplinary applications",
