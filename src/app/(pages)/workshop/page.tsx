...
const workshops: Workshop[] = [
  ...
  },
  {
    id: 2,
    title:
      "Quantum Computing for the Next Generation: Foundations, Myths, and Practical Pathways",
    objective:
    ...
    organizers: [
      {
        name: "Bobby Corpus",
        affiliation: "Quantum Computing Society of the Philippines",
      },
    ],
  },
  {
    ...
    organizers: [
      {
        name: "Henry Adorna",
        affiliation: "Computing Society of the Philippines",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    objective:
      "Programming Competition organized by the Computing Society of the Philippines – Special Interest Group for Women in Computing. The event will be held at the University of the Immaculate Conception, Davao City on April 23, 2026 from 1:30 – 3:30 PM. Each school may send at most 2 teams of 3 female students per team. Each team should be represented by a coach.",
    website: "https://tinyurl.com/pcsc-programming-competition",
    organizers: [
      {
        name: "Computing Society of the Philippines – Special Interest Group for Women in Computing",
        affiliation: "",
      },
  ...
  return (
    <div className="pt-[116px] bg-brick-red-950">
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 sm:py-20">
        ...
        {/* Call to Action */}
        <section aria-label="Workshop Proposal" className="mt-16 text-center">
