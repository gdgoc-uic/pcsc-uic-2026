    ...
    <div className="space-y-12">
      ...
      <div data-animate="item">
        <div className="rounded-lg border border-white/10 bg-rose-950/40 p-8 ring-1 ring-inset ring-white/5 text-center">
          ...
          <p className="text-rose-100/90 text-lg mb-6">
            The list of accepted papers for PCSC 2026 will be announced after
          ...
          <div className="bg-rose-50 border-l-4 border-rose-400 p-4 text-sm text-rose-900 rounded-md shadow-sm max-w-2xl mx-auto">
            <p>
              <strong>Timeline:</strong> Accepted papers will be announced
              approximately 4-6 weeks after the submission deadline. Authors
              will be notified via email once the review process is complete.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border border-white/10 bg-rose-950/40 p-6 ring-1 ring-inset ring-white/5">
            ...
            <p className="text-rose-100/90 mb-4">
              Complete research papers presenting original contributions to
              computing science and related fields.
            </p>
          ...
          <div className="rounded-lg border border-white/10 bg-rose-950/40 p-6 ring-1 ring-inset ring-white/5">
            ...
            <p className="text-rose-100/90 mb-4">
              Work-in-progress papers and preliminary results that contribute to
              the field.
            </p>
            <div className="text-sm text-rose-200">
          ...
          <div className="rounded-lg border border-white/10 bg-rose-950/40 p-6 ring-1 ring-inset ring-white/5">
            ...
            <p className="text-rose-100/90 mb-4">
              Papers authored primarily by students, showcasing their research
              contributions.
            </p>
            <div className="text-sm text-rose-200">
      ...
      <div data-animate="item">
        ...
        <div className="rounded-lg border border-white/10 bg-rose-950/40 p-8 ring-1 ring-inset ring-white/5">
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <h3 className="text-lg font-semibold text-rose-50 mb-4">
