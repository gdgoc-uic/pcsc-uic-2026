    ...
    <div className="pt-20 bg-brick-red-600">
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 sm:py-20">
        ...
        <section aria-label="Committees">
          <h2 className="text-3xl font-bold tracking-tight text-white mb-8">Committees</h2>

          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border border-brick-red-600 bg-brick-red-800 p-8 ring-1 ring-white/5">
              <h3 className="text-xl font-semibold text-white mb-6">Organizing Committee</h3>
              <ul className="space-y-6 text-white">
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">General Chair</span>
                ...
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">Local Chair</span>
                ...
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">Secretariat</span>
                ...
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">General Program Chair</span>
                    <span className="text-sm sm:text-base break-words">Dr. Judith J. Azcarraga</span>
                  </div>
                </li>
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">Documentation and Social Media Team</span>
                ...
                <li className="flex gap-3 sm:gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1 min-w-0">
                    <span className="font-semibold text-white text-sm sm:text-base">Webmaster</span>
            ...
            <div className="rounded-lg border border-brick-red-600 bg-brick-red-800 p-8 ring-1 ring-white/5">
              <h3 className="text-xl font-semibold text-white mb-6">Review Committee</h3>
              {/* 
